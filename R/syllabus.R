...
getSyllabusById <- function(id,connStr){
  ...
  syllabusList <- syllabusCollection$find(query = qryString,fields = '{"name" : true, "acYear": true, "modCode":true, "yearGroup":true, "product":true, "writingAgeSet":true, "writingAge": true,"activeStart":true, "startDate":true, "startYear":true, \"filePrompt_judging\":true, \"filePrompt_studentAssessTab\":true, \"filePrompt_studentJudgeSumm\":true, \"filePrompt_teacherAssessTab\":true}')
  return(syllabusList)
}
...
getSyllabusByProduct <- function(product,connStr){
  ...
  syllabusList <- syllabusCollection$find(query = qryString,fields = '{"name" : true, "acYear": true, "modCode":true, "yearGroup":true, "product":true, "activeStart":true, "startDate":true, "startYear":true, "filePrompt_judging":true, "filePrompt_studentAssessTab":true, "filePrompt_studentJudgeSumm":true, "filePrompt_teacherAssessTab":true}')
  return(syllabusList)
}
